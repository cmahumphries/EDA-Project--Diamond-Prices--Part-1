...
cpi <- read.table("EDA Exercise 1/cpi.csv" , header = TRUE, sep = ",", quote = "\"", na.strings = "")
#view data cpi data
head(cpi)
...
#load in data frame and exmaine header
FBfriends <- read.csv("EDA Exercise 1/FBfriends.csv" , header = TRUE)
head(FBfriends)
...
#how many people share my birthday: none
